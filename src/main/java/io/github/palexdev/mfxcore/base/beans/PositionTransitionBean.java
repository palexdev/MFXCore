 ...
 * </pre>
 */
public class PositionTransitionBean extends PositionBean {
	//================================================================================
	// Properties
	//================================================================================
	...
	// Constructors
	//================================================================================
	public PositionTransitionBean(double x, double y, double endX, double endY) {
		super(x, y);
		this.endX = endX;
		this.endY = endY;
	}
	...
	// Static Methods
	//================================================================================
	public static PositionTransitionBean of(double x, double y, double endX, double endY) {
		return new PositionTransitionBean(x, y, endX, endY);
	}

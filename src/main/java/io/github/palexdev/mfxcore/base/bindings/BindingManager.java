 ...
 * you have a way to set that property, and it must be specified with {@link BindingBuilder#with(BiConsumer)}.
 * <p>
 * For these properties be careful during the unbind op as in JavaFX the getReadOnlyProperty() method returns

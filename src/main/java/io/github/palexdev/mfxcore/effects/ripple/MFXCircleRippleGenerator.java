...
package io.github.palexdev.mfxcore.effects.ripple;
...
import io.github.palexdev.mfxcore.effects.DepthLevel;
import io.github.palexdev.mfxcore.effects.MFXDepthManager;
import io.github.palexdev.mfxcore.effects.ripple.base.AbstractMFXRippleGenerator;
import io.github.palexdev.mfxcore.effects.ripple.base.IRipple;
...
public class MFXCircleRippleGenerator extends AbstractMFXRippleGenerator<MFXCircleRippleGenerator.CircleRipple> {
	...
	protected Animation getBackgroundAnimation() {
		...
		return Animations.TimelineBuilder.build()
				.add(
	 ...
	 *
	 * @see StyleUtils#parseCornerRadius(Region)
	 * @see StyleUtils#setBackground(Region, Paint, CornerRadii)
	 */
	...
	public void defaultClipSupplier() {
		setClipSupplier(() -> new RippleClipTypeBuilder(RippleClipType.RECTANGLE).build(region));
	}
